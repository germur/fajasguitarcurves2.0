...
export class ShopifyMapper {
     ...
     */
    static mapProduct(shopifyProduct, siloType = 'standard') {
        ...
        if (siloType === 'guitar') {
            return {
                ...
                tags: tags.filter(t => ['Espalda Alta', 'Silicone Lace'].includes(t))
            };
        }
    ...
    static getCompressionLevel(tags) {
    ...
    static getOccasionFromTags(tags) {
    ...
    static getFeaturesFromTags(tags, keywords) {
