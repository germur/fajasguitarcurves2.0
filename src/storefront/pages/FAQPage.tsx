        ...
        <div className="bg-[#F9F8F6] min-h-screen font-sans">
            ...
            <div className="bg-[#2C2420] text-white pt-12 pb-24 px-4 text-center relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-2xl mx-auto">
                    <h1 className="font-serif text-3xl md:text-5xl mb-4">{t('pages.faq.hero_title')}</h1>
                    <p className="text-white/80 mb-8 font-light">{t('pages.faq.hero_desc')}</p>
            ...
            <div className="max-w-6xl mx-auto px-4 -mt-10 relative z-20 pb-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <Link to="/pages/guia-de-tallas" className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 group border border-transparent hover:border-[#D4AF37]/30">
                        ...
                        <h3 className="font-serif text-xl text-[#3E322C] mb-2">{t('pages.faq.cards.size.title')}</h3>
                        <p className="text-sm text-gray-500 mb-4">{t('pages.faq.cards.size.desc')}</p>
                        <span className="text-[#D4AF37] text-xs font-bold uppercase tracking-widest flex items-center gap-2">
                            {t('pages.faq.cards.size.btn')} <ArrowRight size={12} />
                        </span>
                    </Link>
                    ...
                    <Link to="/shipping" className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 group border border-transparent hover:border-[#D4AF37]/30">
                        ...
                        <h3 className="font-serif text-xl text-[#3E322C] mb-2">{t('pages.faq.cards.shipping.title')}</h3>
                        <p className="text-sm text-gray-500 mb-4">{t('pages.faq.cards.shipping.desc')}</p>
                        <span className="text-[#D4AF37] text-xs font-bold uppercase tracking-widest flex items-center gap-2">
                            {t('pages.faq.cards.shipping.btn')} <ArrowRight size={12} />
                        </span>
                    </Link>
                    ...
                    <Link to="/colecciones/recuperacion" className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 group border border-transparent hover:border-[#D4AF37]/30">
                        ...
                        <h3 className="font-serif text-xl text-[#3E322C] mb-2">{t('pages.faq.cards.medical.title')}</h3>
                        <p className="text-sm text-gray-500 mb-4">{t('pages.faq.cards.medical.desc')}</p>
                        <span className="text-[#D4AF37] text-xs font-bold uppercase tracking-widest flex items-center gap-2">
                            {t('pages.faq.cards.medical.btn')} <ArrowRight size={12} />
                        </span>
                    </Link>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 group border border-transparent hover:border-[#D4AF37]/30 cursor-pointer">
                        ...
                        <h3 className="font-serif text-xl text-[#3E322C] mb-2">{t('pages.faq.cards.care.title')}</h3>
                        <p className="text-sm text-gray-500 mb-4">{t('pages.faq.cards.care.desc')}</p>
                        <span className="text-[#D4AF37] text-xs font-bold uppercase tracking-widest flex items-center gap-2">
                            {t('pages.faq.cards.care.btn')} <ArrowRight size={12} />
                        </span>
                    </div>
            ...
            <div className="bg-white py-12 border-t border-gray-100">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    <h3 className="font-serif text-2xl text-[#3E322C] mb-4">{t('pages.faq.cta_title')}</h3>
                    <p className="text-gray-500 mb-8">{t('pages.faq.cta_desc')}</p>
                    <a
