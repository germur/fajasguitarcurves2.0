                ...
                <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-4 gap-4 h-auto md:h-[600px]">
                    ...
                    <Link to="/colecciones/recuperacion" className="group relative h-[300px] md:h-auto md:col-span-2 md:row-span-2 rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 bg-[#B49286]">
                        ...
                        <div className="absolute bottom-6 left-6 text-white z-20 max-w-xs">
                            <h3 className="font-serif text-2xl font-bold mb-1">Fajas Postquirúrgicas</h3>
                            <p className="text-xs text-stone-200 leading-relaxed line-clamp-3">
                                Acelera tu recuperación con ingeniería textil de grado médico para Etapa 2 y 3.
                            </p>
                        </div>
                    ...
                    {/* 3. Reloj de Arena (Medium - Right Bottom - 2 Rows - Expanded) */}
                    <Link to="/colecciones/moldeo-y-estetica" className="group relative h-[250px] md:h-auto md:col-span-2 md:row-span-2 rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 bg-[#EAE6E3] p-6 flex flex-col justify-between">
                        <img
                        ...
                        <div className="relative z-10 max-w-xs">
                            <h3 className="font-serif text-xl font-bold text-[#2C2420] leading-tight mb-2">Efecto <br />Reloj de Arena</h3>
                            <p className="text-[10px] text-stone-600 uppercase tracking-widest font-bold leading-relaxed">
                                Moldea tu cintura y realza curvas naturales sin aplastar.
                            </p>
                        </div>
